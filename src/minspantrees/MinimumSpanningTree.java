...
/**
 * A result object returned by a {@link graphs.minspantrees.MinimumSpanningTreeFinder}.
 */
public interface MinimumSpanningTree<V, E extends BaseEdge<V, E>> {
    ...
    class Success<V, E extends BaseEdge<V, E>> implements graphs.minspantrees.MinimumSpanningTree<V, E> {
    ...
    class Failure<V, E extends BaseEdge<V, E>> implements graphs.minspantrees.MinimumSpanningTree<V, E> {
        Failure() {}
